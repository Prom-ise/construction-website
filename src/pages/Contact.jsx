  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch(
        "https://construct-backend.onrender.com/api/contact",
        {
          method: "POST",
    ...
    <div>
      ...
      >
        ...
        <div className="relative z-10">
          <h1 className="text-3xl md:text-6xl mt-[2em] font-bold text-start text-white">
            Contact Us
          </h1>
          <h3 className="text-white text-base md:text-lg">
            Get in touch with us about your next construction project
          </h3>
        </div>
      </div>
      ...
      {/* Form Section */}
      <form
        className="max-w-6xl container mx-auto px-4 md:px-[4em] my-10 md:my-[7em]"
      ...
      >
        ...
        {status && (
          <p className="mb-4 text-center font-semibold text-blue-500">
            {status}
          </p>
        )}
       ...
       <button
  type="submit"
  className="bg-[#fe5d14] hover:bg-[#d86733] text-white font-semibold px-6 py-3 rounded-lg transition w-full md:w-auto disabled:opacity-60 disabled:cursor-not-allowed"
